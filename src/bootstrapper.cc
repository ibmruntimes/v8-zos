...
#define DECLARE_FEATURE_INITIALIZATION(id, descr) \
  ...
  DECLARE_FEATURE_INITIALIZATION(promise_extra, u8"")
...
static void SetObjectPrototype(Handle<JSObject> object, Handle<Object> proto) {
  ...
  Handle<Map> new_map = Map::Copy(old_map, "\x53\x65\x74\x4f\x62\x6a\x65\x63\x74\x50\x72\x6f\x74\x6f\x74\x79\x70\x65");
...
Handle<JSFunction> Genesis::CreateEmptyFunction(Isolate* isolate) {
  ...
  {  // --- O b j e c t ---
    ...
    Handle<Map> map = Map::Copy(handle(object_function_prototype->map()),
                                "\x45\x6d\x70\x74\x79\x4f\x62\x6a\x65\x63\x74\x50\x72\x6f\x74\x6f\x74\x79\x70\x65");
  ...
  // --- E m p t y ---
  Handle<String> source = factory->NewStringFromStaticChars("\x28\x29\x20\x7b\x7d");
...
Handle<JSFunction> Genesis::GetThrowTypeErrorIntrinsic(
  ...
  Handle<String> name =
      factory()->InternalizeOneByteString(STATIC_CHAR_VECTOR("\x54\x68\x72\x6f\x77\x54\x79\x70\x65\x45\x72\x72\x6f\x72"));
...
void Genesis::CreateIteratorMaps() {
  ...
  JSObject::AddProperty(generator_function_prototype,
                        factory()->InternalizeUtf8String("\x70\x72\x6f\x74\x6f\x74\x79\x70\x65"),
  ...
  Handle<Map> sloppy_generator_function_map =
      Map::Copy(strict_function_map, "\x53\x6c\x6f\x70\x70\x79\x47\x65\x6e\x65\x72\x61\x74\x6f\x72\x46\x75\x6e\x63\x74\x69\x6f\x6e");
  ...
  Handle<Map> strict_generator_function_map =
      Map::Copy(strict_function_map, "\x53\x74\x72\x69\x63\x74\x47\x65\x6e\x65\x72\x61\x74\x6f\x72\x46\x75\x6e\x63\x74\x69\x6f\x6e");
...
void Genesis::CreateJSProxyMaps() {
  ...
  Handle<Map> proxy_function_map =
      Map::Copy(isolate()->sloppy_function_without_prototype_map(), "\x50\x72\x6f\x78\x79");
  ...
  Handle<Map> proxy_callable_map = Map::Copy(proxy_map, "\x63\x61\x6c\x6c\x61\x62\x6c\x65\x20\x50\x72\x6f\x78\x79");
  ...
  Handle<Map> proxy_constructor_map =
      Map::Copy(proxy_callable_map, "\x63\x6f\x6e\x73\x74\x72\x75\x63\x74\x6f\x72\x20\x50\x72\x6f\x78\x79");
...
void Genesis::InitializeGlobal(Handle<JSGlobalObject> global_object,
  ...
  {  // --- O b j e c t ---
    ...
    Handle<JSFunction> object_freeze = SimpleInstallFunction(
        object_function, "\x66\x72\x65\x65\x7a\x65", Builtins::kObjectFreeze, 1, false);
    native_context()->set_object_freeze(*object_freeze);
    SimpleInstallFunction(object_function, "\x67\x65\x74\x4f\x77\x6e\x50\x72\x6f\x70\x65\x72\x74\x79\x44\x65\x73\x63\x72\x69\x70\x74\x6f\x72",
                          Builtins::kObjectGetOwnPropertyDescriptor, 2, false);
    SimpleInstallFunction(object_function, "\x67\x65\x74\x4f\x77\x6e\x50\x72\x6f\x70\x65\x72\x74\x79\x4e\x61\x6d\x65\x73",
                          Builtins::kObjectGetOwnPropertyNames, 1, false);
    SimpleInstallFunction(object_function, "\x67\x65\x74\x4f\x77\x6e\x50\x72\x6f\x70\x65\x72\x74\x79\x53\x79\x6d\x62\x6f\x6c\x73",
                          Builtins::kObjectGetOwnPropertySymbols, 1, false);
    SimpleInstallFunction(object_function, "\x69\x73", Builtins::kObjectIs, 2, true);
    Handle<JSFunction> object_is_extensible =
        SimpleInstallFunction(object_function, "\x69\x73\x45\x78\x74\x65\x6e\x73\x69\x62\x6c\x65",
    ...
    Handle<JSFunction> object_is_frozen = SimpleInstallFunction(
        object_function, "\x69\x73\x46\x72\x6f\x7a\x65\x6e", Builtins::kObjectIsFrozen, 1, false);
    native_context()->set_object_is_frozen(*object_is_frozen);
    Handle<JSFunction> object_is_sealed = SimpleInstallFunction(
        object_function, "\x69\x73\x53\x65\x61\x6c\x65\x64", Builtins::kObjectIsSealed, 1, false);
    native_context()->set_object_is_sealed(*object_is_sealed);
    Handle<JSFunction> object_keys = SimpleInstallFunction(
        object_function, "\x6b\x65\x79\x73", Builtins::kObjectKeys, 1, false);
    native_context()->set_object_keys(*object_keys);
    SimpleInstallFunction(object_function, "\x70\x72\x65\x76\x65\x6e\x74\x45\x78\x74\x65\x6e\x73\x69\x6f\x6e\x73",
                          Builtins::kObjectPreventExtensions, 1, false);
    SimpleInstallFunction(object_function, "\x73\x65\x61\x6c", Builtins::kObjectSeal, 1,
                          false);

    SimpleInstallFunction(isolate->initial_object_prototype(), "\x68\x61\x73\x4f\x77\x6e\x50\x72\x6f\x70\x65\x72\x74\x79",
  ...
  {  // --- A r r a y ---
    ...
    Handle<JSFunction> is_arraylike = SimpleInstallFunction(
        array_function, isolate->factory()->InternalizeUtf8String("\x69\x73\x41\x72\x72\x61\x79"),
  ...
  {  // --- N u m b e r ---
    Handle<JSFunction> number_fun = InstallFunction(
        global, "\x4e\x75\x6d\x62\x65\x72", JS_VALUE_TYPE, JSValue::kSize,
  ...
  {  // --- B o o l e a n ---
    ...
    SimpleInstallFunction(prototype, "\x74\x6f\x53\x74\x72\x69\x6e\x67",
                          Builtins::kBooleanPrototypeToString, 0, false);
    SimpleInstallFunction(prototype, "\x76\x61\x6c\x75\x65\x4f\x66",
                          Builtins::kBooleanPrototypeValueOf, 0, false);
  }

  {  // --- S t r i n g ---
    Handle<JSFunction> string_fun = InstallFunction(
        global, "\x53\x74\x72\x69\x6e\x67", JS_VALUE_TYPE, JSValue::kSize,
...

  {
    ...
    Handle<JSFunction> symbol_fun =
        InstallFunction(global, "\x53\x79\x6d\x62\x6f\x6c", JS_VALUE_TYPE, JSValue::kSize,
  ...
  {  // --- D a t e ---
    ...
    Handle<JSFunction> date_fun =
        InstallFunction(global, "\x44\x61\x74\x65", JS_DATE_TYPE, JSDate::kSize, prototype,
    ...
    SimpleInstallFunction(date_fun, "\x6e\x6f\x77", Builtins::kDateNow, 0, false);
    SimpleInstallFunction(date_fun, "\x70\x61\x72\x73\x65", Builtins::kDateParse, 1, false);
    SimpleInstallFunction(date_fun, "\x55\x54\x43", Builtins::kDateUTC, 7, false);
    ...
    SimpleInstallFunction(prototype, "\x74\x6f\x44\x61\x74\x65\x53\x74\x72\x69\x6e\x67",
                          Builtins::kDatePrototypeToDateString, 0, false);
    SimpleInstallFunction(prototype, "\x74\x6f\x54\x69\x6d\x65\x53\x74\x72\x69\x6e\x67",
                          Builtins::kDatePrototypeToTimeString, 0, false);
    SimpleInstallFunction(prototype, "\x74\x6f\x49\x53\x4f\x53\x74\x72\x69\x6e\x67",
                          Builtins::kDatePrototypeToISOString, 0, false);
    Handle<JSFunction> to_utc_string =
        SimpleInstallFunction(prototype, "\x74\x6f\x55\x54\x43\x53\x74\x72\x69\x6e\x67",
                              Builtins::kDatePrototypeToUTCString, 0, false);
    InstallFunction(prototype, to_utc_string,
                    factory->InternalizeUtf8String("\x74\x6f\x47\x4d\x54\x53\x74\x72\x69\x6e\x67"), DONT_ENUM);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x44\x61\x74\x65", Builtins::kDatePrototypeGetDate,
                          0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x44\x61\x74\x65", Builtins::kDatePrototypeSetDate,
                          1, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x44\x61\x79", Builtins::kDatePrototypeGetDay,
                          0, true);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x46\x75\x6c\x6c\x59\x65\x61\x72",
                          Builtins::kDatePrototypeGetFullYear, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x46\x75\x6c\x6c\x59\x65\x61\x72",
                          Builtins::kDatePrototypeSetFullYear, 3, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x48\x6f\x75\x72\x73",
                          Builtins::kDatePrototypeGetHours, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x48\x6f\x75\x72\x73",
                          Builtins::kDatePrototypeSetHours, 4, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x4d\x69\x6c\x6c\x69\x73\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeGetMilliseconds, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x4d\x69\x6c\x6c\x69\x73\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeSetMilliseconds, 1, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x4d\x69\x6e\x75\x74\x65\x73",
                          Builtins::kDatePrototypeGetMinutes, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x4d\x69\x6e\x75\x74\x65\x73",
                          Builtins::kDatePrototypeSetMinutes, 3, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x4d\x6f\x6e\x74\x68",
                          Builtins::kDatePrototypeGetMonth, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x4d\x6f\x6e\x74\x68",
                          Builtins::kDatePrototypeSetMonth, 2, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x53\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeGetSeconds, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x53\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeSetSeconds, 2, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x54\x69\x6d\x65", Builtins::kDatePrototypeGetTime,
                          0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x54\x69\x6d\x65", Builtins::kDatePrototypeSetTime,
                          1, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x54\x69\x6d\x65\x7a\x6f\x6e\x65\x4f\x66\x66\x73\x65\x74",
                          Builtins::kDatePrototypeGetTimezoneOffset, 0, true);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x44\x61\x74\x65",
                          Builtins::kDatePrototypeGetUTCDate, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x44\x61\x74\x65",
                          Builtins::kDatePrototypeSetUTCDate, 1, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x44\x61\x79",
                          Builtins::kDatePrototypeGetUTCDay, 0, true);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x46\x75\x6c\x6c\x59\x65\x61\x72",
                          Builtins::kDatePrototypeGetUTCFullYear, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x46\x75\x6c\x6c\x59\x65\x61\x72",
                          Builtins::kDatePrototypeSetUTCFullYear, 3, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x48\x6f\x75\x72\x73",
                          Builtins::kDatePrototypeGetUTCHours, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x48\x6f\x75\x72\x73",
                          Builtins::kDatePrototypeSetUTCHours, 4, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x4d\x69\x6c\x6c\x69\x73\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeGetUTCMilliseconds, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x4d\x69\x6c\x6c\x69\x73\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeSetUTCMilliseconds, 1, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x4d\x69\x6e\x75\x74\x65\x73",
                          Builtins::kDatePrototypeGetUTCMinutes, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x4d\x69\x6e\x75\x74\x65\x73",
                          Builtins::kDatePrototypeSetUTCMinutes, 3, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x4d\x6f\x6e\x74\x68",
                          Builtins::kDatePrototypeGetUTCMonth, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x4d\x6f\x6e\x74\x68",
                          Builtins::kDatePrototypeSetUTCMonth, 2, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x55\x54\x43\x53\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeGetUTCSeconds, 0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x55\x54\x43\x53\x65\x63\x6f\x6e\x64\x73",
                          Builtins::kDatePrototypeSetUTCSeconds, 2, false);
    SimpleInstallFunction(prototype, "\x76\x61\x6c\x75\x65\x4f\x66", Builtins::kDatePrototypeValueOf,
                          0, false);
    SimpleInstallFunction(prototype, "\x67\x65\x74\x59\x65\x61\x72", Builtins::kDatePrototypeGetYear,
                          0, true);
    SimpleInstallFunction(prototype, "\x73\x65\x74\x59\x65\x61\x72", Builtins::kDatePrototypeSetYear,
                          1, false);

    // Install i18n fallback functions.
    SimpleInstallFunction(prototype, "\x74\x6f\x4c\x6f\x63\x61\x6c\x65\x53\x74\x72\x69\x6e\x67",
                          Builtins::kDatePrototypeToString, 0, false);
    SimpleInstallFunction(prototype, "\x74\x6f\x4c\x6f\x63\x61\x6c\x65\x44\x61\x74\x65\x53\x74\x72\x69\x6e\x67",
                          Builtins::kDatePrototypeToDateString, 0, false);
    SimpleInstallFunction(prototype, "\x74\x6f\x4c\x6f\x63\x61\x6c\x65\x54\x69\x6d\x65\x53\x74\x72\x69\x6e\x67",
                          Builtins::kDatePrototypeToTimeString, 0, false);
  ...
  {  // -- E r r o r
    Handle<JSFunction> error_fun = InstallFunction(
        global, "\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
  ...
  {  // -- E v a l E r r o r
    Handle<JSFunction> eval_error_fun = InstallFunction(
        global, "\x45\x76\x61\x6c\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- R a n g e E r r o r
    Handle<JSFunction> range_error_fun = InstallFunction(
        global, "\x52\x61\x6e\x67\x65\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- R e f e r e n c e E r r o r
    Handle<JSFunction> reference_error_fun = InstallFunction(
        global, "\x52\x65\x66\x65\x72\x65\x6e\x63\x65\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- S y n t a x E r r o r
    Handle<JSFunction> syntax_error_fun = InstallFunction(
        global, "\x53\x79\x6e\x74\x61\x78\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- T y p e E r r o r
    Handle<JSFunction> type_error_fun = InstallFunction(
        global, "\x54\x79\x70\x65\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- U R I E r r o r
    Handle<JSFunction> uri_error_fun = InstallFunction(
        global, "\x55\x52\x49\x45\x72\x72\x6f\x72", JS_OBJECT_TYPE, JSObject::kHeaderSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- M a t h
    Handle<String> name = factory->InternalizeUtf8String("\x4d\x61\x74\x68");
    Handle<JSFunction> cons = factory->NewFunction(name);
    ...
    SimpleInstallFunction(math, "\x61\x63\x6f\x73", Builtins::kMathAcos, 1, true);
    SimpleInstallFunction(math, "\x61\x73\x69\x6e", Builtins::kMathAsin, 1, true);
    SimpleInstallFunction(math, "\x61\x74\x61\x6e", Builtins::kMathAtan, 1, true);
    SimpleInstallFunction(math, "\x63\x65\x69\x6c", Builtins::kMathCeil, 1, true);
    SimpleInstallFunction(math, "\x63\x6c\x7a\x33\x32", Builtins::kMathClz32, 1, true);
    Handle<JSFunction> math_floor =
        SimpleInstallFunction(math, "\x66\x6c\x6f\x6f\x72", Builtins::kMathFloor, 1, true);
    native_context()->set_math_floor(*math_floor);
    SimpleInstallFunction(math, "\x66\x72\x6f\x75\x6e\x64", Builtins::kMathFround, 1, true);
    SimpleInstallFunction(math, "\x69\x6d\x75\x6c", Builtins::kMathImul, 2, true);
    SimpleInstallFunction(math, "\x6d\x61\x78", Builtins::kMathMax, 2, false);
    SimpleInstallFunction(math, "\x6d\x69\x6e", Builtins::kMathMin, 2, false);
    SimpleInstallFunction(math, "\x72\x6f\x75\x6e\x64", Builtins::kMathRound, 1, true);
    Handle<JSFunction> math_sqrt =
        SimpleInstallFunction(math, "\x73\x71\x72\x74", Builtins::kMathSqrt, 1, true);
    native_context()->set_math_sqrt(*math_sqrt);
    SimpleInstallFunction(math, "\x74\x72\x75\x6e\x63", Builtins::kMathTrunc, 1, true);
  }

  {  // -- A r r a y B u f f e r
    Handle<JSFunction> array_buffer_fun =
        InstallArrayBuffer(global, "\x41\x72\x72\x61\x79\x42\x75\x66\x66\x65\x72");
...
#define INSTALL_TYPED_ARRAY(Type, type, TYPE, ctype, size)             \
  {                                                                    \
    Handle<JSFunction> fun;                                            \
    InstallTypedArray(USTR(#Type) "\x41\x72\x72\x61\x79", TYPE##_ELEMENTS, &fun);           \
...
#undef INSTALL_TYPED_ARRAY
  ...
  {  // -- M a p
    Handle<JSFunction> js_map_fun = InstallFunction(
        global, "\x4d\x61\x70", JS_MAP_TYPE, JSMap::kSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- S e t
    Handle<JSFunction> js_set_fun = InstallFunction(
        global, "\x53\x65\x74", JS_SET_TYPE, JSSet::kSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- W e a k M a p
    Handle<JSFunction> js_weak_map_fun = InstallFunction(
        global, "\x57\x65\x61\x6b\x4d\x61\x70", JS_WEAK_MAP_TYPE, JSWeakMap::kSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- W e a k S e t
    Handle<JSFunction> js_weak_set_fun = InstallFunction(
        global, "\x57\x65\x61\x6b\x53\x65\x74", JS_WEAK_SET_TYPE, JSWeakSet::kSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
  ...
  {  // -- R e f l e c t
    Handle<String> reflect_string = factory->InternalizeUtf8String("\x52\x65\x66\x6c\x65\x63\x74");
  ...
  {  // --- B o u n d F u n c t i o n
    ...
    map = Map::Copy(map, "\x49\x73\x43\x6f\x6e\x73\x74\x72\x75\x63\x74\x6f\x72");
  ...
  {  // --- fast and slow aliased arguments map
    ...
    map = Map::Copy(map, "\x46\x61\x73\x74\x41\x6c\x69\x61\x73\x65\x64\x41\x72\x67\x75\x6d\x65\x6e\x74\x73");
    ...
    map = Map::Copy(map, "\x53\x6c\x6f\x77\x41\x6c\x69\x61\x73\x65\x64\x41\x72\x67\x75\x6d\x65\x6e\x74\x73");
  ...
  {  // --- context extension
    ...
    Handle<String> name = factory->InternalizeOneByteString(
        STATIC_CHAR_VECTOR("\x63\x6f\x6e\x74\x65\x78\x74\x5f\x65\x78\x74\x65\x6e\x73\x69\x6f\x6e"));
...
#define EXPORT_PRIVATE_SYMBOL(NAME)                                       \
  Handle<String> NAME##_name = factory->NewStringFromAsciiChecked(USTR(#NAME)); \
...
#undef EXPORT_PUBLIC_SYMBOL

  {
    Handle<JSFunction> to_string = InstallFunction(
        container, "\x6f\x62\x6a\x65\x63\x74\x5f\x74\x6f\x5f\x73\x74\x72\x69\x6e\x67", JS_OBJECT_TYPE, JSObject::kHeaderSize,
...

  {
    ...
    JSObject::AddProperty(container,
                          factory->InternalizeUtf8String("\x49\x74\x65\x72\x61\x74\x6f\x72\x50\x72\x6f\x74\x6f\x74\x79\x70\x65"),
...

  {
    ...
    JSObject::AddProperty(
        container, factory->InternalizeUtf8String("\x47\x65\x6e\x65\x72\x61\x74\x6f\x72\x46\x75\x6e\x63\x74\x69\x6f\x6e\x50\x72\x6f\x74\x6f\x74\x79\x70\x65"),
        generator_function_prototype, NONE);

    static const bool kUseStrictFunctionMap = true;
    Handle<JSFunction> generator_function_function = InstallFunction(
        container, "\x47\x65\x6e\x65\x72\x61\x74\x6f\x72\x46\x75\x6e\x63\x74\x69\x6f\x6e", JS_FUNCTION_TYPE, JSFunction::kSize,
  ...
  {  // -- S e t I t e r a t o r
    ...
    Handle<JSFunction> set_iterator_function = InstallFunction(
        container, "\x53\x65\x74\x49\x74\x65\x72\x61\x74\x6f\x72", JS_SET_ITERATOR_TYPE, JSSetIterator::kSize,
  ...
  {  // -- M a p I t e r a t o r
    ...
    Handle<JSFunction> map_iterator_function = InstallFunction(
        container, "\x4d\x61\x70\x49\x74\x65\x72\x61\x74\x6f\x72", JS_MAP_ITERATOR_TYPE, JSMapIterator::kSize,
  ...
  {  // -- S c r i p t
    ...
    Handle<JSFunction> script_fun = InstallFunction(
        container, "\x53\x63\x72\x69\x70\x74", JS_VALUE_TYPE, JSValue::kSize,
        isolate->initial_object_prototype(), Builtins::kIllegal);
    Handle<JSObject> prototype =
        factory->NewJSObject(isolate->object_function(), TENURED);
...
#define INITIALIZE_FLAG(FLAG)                                         \
  {                                                                   \
    Handle<String> name =                                             \
        isolate->factory()->NewStringFromAsciiChecked(USTR(#FLAG));         \
...
void InstallPublicSymbol(Factory* factory, Handle<Context> native_context,
  ...
  Handle<String> symbol_string = factory->InternalizeUtf8String("\x53\x79\x6d\x62\x6f\x6c");
...
void Genesis::InitializeGlobal_harmony_regexp_subclass() {
  ...
  InstallPublicSymbol(factory(), native_context(), "\x6d\x61\x74\x63\x68",
                      factory()->match_symbol());
  InstallPublicSymbol(factory(), native_context(), "\x72\x65\x70\x6c\x61\x63\x65",
                      factory()->replace_symbol());
  InstallPublicSymbol(factory(), native_context(), "\x73\x65\x61\x72\x63\x68",
                      factory()->search_symbol());
  InstallPublicSymbol(factory(), native_context(), "\x73\x70\x6c\x69\x74",
...
void Genesis::InitializeGlobal_harmony_sharedarraybuffer() {
  ...
  Handle<JSFunction> shared_array_buffer_fun =
      InstallArrayBuffer(global, "\x53\x68\x61\x72\x65\x64\x41\x72\x72\x61\x79\x42\x75\x66\x66\x65\x72");
...
void Genesis::InitializeGlobal_harmony_simd() {
  ...
  Handle<String> name = factory->InternalizeUtf8String("\x53\x49\x4d\x44");
  Handle<JSFunction> cons = factory->NewFunction(name);
  JSFunction::SetInstancePrototype(
      cons,
      Handle<Object>(native_context()->initial_object_prototype(), isolate));
...
#define SIMD128_INSTALL_FUNCTION(TYPE, Type, type, lane_count, lane_type) \
  Handle<JSFunction> type##_function = InstallFunction(                   \
      simd_object, USTR(#Type), JS_VALUE_TYPE, JSValue::kSize,                  \
      isolate->initial_object_prototype(), Builtins::kIllegal);           \
...
void Genesis::InitializeGlobal_harmony_species() {
  ...
  InstallPublicSymbol(factory(), native_context(), "\x73\x70\x65\x63\x69\x65\x73",
...
Handle<JSFunction> Genesis::InstallInternalArray(Handle<JSObject> target,
  ...
  Handle<Map> initial_map = Map::Copy(original_map, "\x49\x6e\x74\x65\x72\x6e\x61\x6c\x41\x72\x72\x61\x79");
...
bool Genesis::InstallNatives(GlobalContextType context_type) {
  ...
  JSObject::NormalizeProperties(utils, CLEAR_INOBJECT_PROPERTIES, 16,
                                "\x75\x74\x69\x6c\x73\x20\x63\x6f\x6e\x74\x61\x69\x6e\x65\x72\x20\x66\x6f\x72\x20\x6e\x61\x74\x69\x76\x65\x20\x73\x63\x72\x69\x70\x74\x73");
  ...
  InstallInternalArray(extras_utils, "\x49\x6e\x74\x65\x72\x6e\x61\x6c\x50\x61\x63\x6b\x65\x64\x41\x72\x72\x61\x79", FAST_ELEMENTS);

  int builtin_index = Natives::GetDebuggerCount();
  // Only run prologue.js and runtime.js at this point.
  DCHECK_EQ(builtin_index, Natives::GetIndex("\x70\x72\x6f\x6c\x6f\x67\x75\x65"));
  if (!Bootstrapper::CompileBuiltin(isolate(), builtin_index++)) return false;
  DCHECK_EQ(builtin_index, Natives::GetIndex("\x72\x75\x6e\x74\x69\x6d\x65"));
  if (!Bootstrapper::CompileBuiltin(isolate(), builtin_index++)) return false;
  ...
  // transition easy to trap. Moreover, they rarely are smi-only.
  {
    ...
    Handle<JSObject> utils =
        Handle<JSObject>::cast(isolate()->natives_utils_object());
    Handle<JSFunction> array_function =
        InstallInternalArray(utils, "\x49\x6e\x74\x65\x72\x6e\x61\x6c\x41\x72\x72\x61\x79", FAST_HOLEY_ELEMENTS);
    native_context()->set_internal_array_function(*array_function);
    InstallInternalArray(utils, "\x49\x6e\x74\x65\x72\x6e\x61\x6c\x50\x61\x63\x6b\x65\x64\x41\x72\x72\x61\x79", FAST_ELEMENTS);
  }
  ...
  if (!CallUtilsFunction(isolate(), "\x50\x6f\x73\x74\x4e\x61\x74\x69\x76\x65\x73")) return false;
  ...
  // Install Array.prototype.concat
  {
    ...
    Handle<JSFunction> concat =
        InstallFunction(proto, "\x63\x6f\x6e\x63\x61\x74", JS_OBJECT_TYPE, JSObject::kHeaderSize,
  ...
  // operations are not supported by Crankshaft, TurboFan, nor Ignition.
  {
    ...
    {  // GeneratorObject.prototype.return
      Handle<String> key = factory()->NewStringFromAsciiChecked("\x72\x65\x74\x75\x72\x6e");
      Handle<JSFunction> function = Handle<JSFunction>::cast(
          JSReceiver::GetProperty(generator_object_prototype, key)
              .ToHandleChecked());
...
bool Genesis::InstallExperimentalNatives() {
  ...
  static const char* harmony_species_natives[] = {"\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x73\x70\x65\x63\x69\x65\x73\x2e\x6a\x73",
                                                  nullptr};
  static const char* harmony_tailcalls_natives[] = {nullptr};
  static const char* harmony_unicode_regexps_natives[] = {
      "\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x75\x6e\x69\x63\x6f\x64\x65\x2d\x72\x65\x67\x65\x78\x70\x73\x2e\x6a\x73", nullptr};
  static const char* harmony_object_observe_natives[] = {
      "\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x6f\x62\x6a\x65\x63\x74\x2d\x6f\x62\x73\x65\x72\x76\x65\x2e\x6a\x73", nullptr};
  static const char* harmony_sharedarraybuffer_natives[] = {
      "\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x73\x68\x61\x72\x65\x64\x61\x72\x72\x61\x79\x62\x75\x66\x66\x65\x72\x2e\x6a\x73", "\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x61\x74\x6f\x6d\x69\x63\x73\x2e\x6a\x73", NULL};
  static const char* harmony_simd_natives[] = {"\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x73\x69\x6d\x64\x2e\x6a\x73",
                                               nullptr};
  static const char* harmony_do_expressions_natives[] = {nullptr};
  static const char* harmony_regexp_exec_natives[] = {
      "\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x72\x65\x67\x65\x78\x70\x2d\x65\x78\x65\x63\x2e\x6a\x73", nullptr};
  ...
  static const char* promise_extra_natives[] = {"\x6e\x61\x74\x69\x76\x65\x20\x70\x72\x6f\x6d\x69\x73\x65\x2d\x65\x78\x74\x72\x61\x2e\x6a\x73",
                                                nullptr};
  ...
  static const char* harmony_string_padding_natives[] = {
      "\x6e\x61\x74\x69\x76\x65\x20\x68\x61\x72\x6d\x6f\x6e\x79\x2d\x73\x74\x72\x69\x6e\x67\x2d\x70\x61\x64\x64\x69\x6e\x67\x2e\x6a\x73", nullptr};
...
#undef INSTALL_EXPERIMENTAL_NATIVES
  ...
  if (!CallUtilsFunction(isolate(), "\x50\x6f\x73\x74\x45\x78\x70\x65\x72\x69\x6d\x65\x6e\x74\x61\x6c\x73")) return false;
...
bool Genesis::InstallDebuggerNatives() {
  ...
  return CallUtilsFunction(isolate(), "\x50\x6f\x73\x74\x44\x65\x62\x75\x67");
}
...
#define INSTALL_BUILTIN_ID(holder_expr, fun_name, name) \
  { USTR(#holder_expr), USTR(#fun_name), k##name }                  \
  ,
...
bool Genesis::InstallSpecialObjects(Handle<Context> native_context) {
  ...
  Handle<String> name =
      factory->InternalizeOneByteString(STATIC_CHAR_VECTOR("\x73\x74\x61\x63\x6b\x54\x72\x61\x63\x65\x4c\x69\x6d\x69\x74"));
